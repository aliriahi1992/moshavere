...
class CustomUserAdmin(UserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('mobile_number', 'full_name', 'password1', 'password2', 'balance', 'is_staff', 'is_admin', 'is_active','is_forget','is_webservice','webservice_from_who','webservice_origin','webservice_discount_code','webservice_campaign_name','webservice_total_request_limit','webservice_user_request_limit','webservice_question_price'),
        }),
    )
