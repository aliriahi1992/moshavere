            ...
            if user :
                if user.balance >0 :    
                    ...
                    try:
                        ...
                        if section == 1:
                            prompt = "به عنوان یک مشاور در زمینه پوست و مو پاسخ این سوال رو بده و در آخر هم به مخاطب بگو برای خرید اینترنتی از " + user.full_name + "  میتونه از کد تخفیف " + user.webservice_discount_code + " " + user.webservice_campaign_name +" استفاده کنه : " + str(question)
                        elif section == 2:
