            ...
            if user :
                if user.balance >0 :    
                    ...
                    try:
                        ...
                        if section == 1:
                            prompt = "به عنوان یک مشاور در زمینه پوست و مو پاسخ این سوال رو بده و در آخر هم به مخاطب پیشنعاد بده که خریدش رو از " + user.full_name + "  میتونه به راحتی انجام بده : " + str(question)
                        elif section == 2:
