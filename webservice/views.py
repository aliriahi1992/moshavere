            ...
            if user :
                if user.balance >0 :    
                    ...
                    try:
                        ...
                        if section == 1:
                            prompt = "به عنوان یک مشاور در زمینه پوست و مو پاسخ این سوال رو به مخاطب بده و بعد از اون ازش بابت مشاوره گرفتن در  " + user.full_name + "  تشکر کن و بعد از اون بهش استفاده از  "+ user.webservice_campaign_name+ " رو پیشنهاد کن که بدون نیاز به کد تخفیف میتونه ازش استفاده کنه : " + str(question)
                        elif section == 2:
