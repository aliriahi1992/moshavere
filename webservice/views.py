            ...
            if user :
                if user.balance >0 :    
                    ...
                    try:
                        ...
                        if section == 1:
                            prompt = "به عنوان یک مشاور در زمینه پوست و مو پاسخ این سوال رو بده و در آخر هم به مخاطب بگو برای خرید اینترنتی از " + user.full_name + "  میتونه از کد تخفیف 'shavaz' استفاده کنه : " + str(question)
                        elif section == 2:
