        ...
        if number:
            try:
                ...
                if section == 1:
                    ...
                    prompt = "به عنوان یک مشاور یا درمانگر روابط خانواده پاسخ این سوال رو بده و اگر در حوزه تخصص یک مشاور یا درمانگر روابط خانواده نیست بگو توی حوزه تو نیست پاسخ دادن به این سوال " + str(number)
                elif section == 4:
