...
class QuestionHistoryResource(resources.ModelResource):
    class Meta:
        ...
        fields = ('id', 'created_at', 'status', 'user_phone_number', 'user_full_name', 'question', 'from_who', 'api_key_name', 'credit', 'user_os','webservice_user', 'webservice_discount_code' , 'webservice_campaign_name')
...
class QuestionHistoryAdmin(ExportMixin, admin.ModelAdmin):
    list_display = ('status', 'user_full_name', 'user_phone_number', 'created_at', 'question', 'from_who', 'credit', 'user_os','webservice_user', 'webservice_discount_code' , 'webservice_campaign_name')
